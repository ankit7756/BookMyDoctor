...
const Doctors = () => {
    ...
    const specialties = [
        { id: "general-physician", name: "General Physician", value: "General physician" },
        { id: "gynecologist", name: "Gynecologist", value: "Gynecologist" },
        { id: "dermatologist", name: "Dermatologist", value: "Dermatologist" },
        { id: "pediatricians", name: "Pediatricians", value: "Pediatricians" },
        { id: "neurologist", name: "Neurologist", value: "Neurologist" },
        { id: "gastroenterologist", name: "Gastroenterologist", value: "Gastroenterologist" },
    ];
    ...
    return (
        <div className="py-16 bg-gradient-to-b from-white via-slate-50 to-blue-50 min-h-screen relative overflow-hidden">
            {/* Background elements */}
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-12 relative">
                    <span className="text-sm font-bold tracking-wider text-indigo-600 uppercase bg-indigo-100 px-3 py-1 rounded-full mb-3 inline-block animate-fade-in">Find Your Specialist</span>
                    ...
                    <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto mt-4 animate-fade-in delay-300">
                        Browse through our team of experienced medical professionals and find the right specialist for your health needs
                    </p>
                </div>
                    ...
                    <div className="lg:w-1/4">
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 sticky top-24">
                            ...
                            >
                                ...
                                <svg className={`w-5 h-5 transition-transform duration-300 ${showFilter ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className={`transition-all duration-300 ${showFilter ? 'max-h-72 opacity-100' : 'max-h-0 opacity-0 lg:max-h-96 lg:opacity-100'} overflow-y-auto pr-1`}>
                                <div className="space-y-3">
                                    <div
                                        ...
                                        className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all duration-200 ${!speciality ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-md' : 'hover:bg-indigo-50'}`}
                                    >
                                        <svg className={`w-5 h-5 ${!speciality ? 'text-white' : 'text-indigo-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                        </svg>
                                        <span className="font-medium">All Specialists</span>
                                    </div>

                                    {specialties.map((item) => (
                                        <div
                                            key={item.id}
                                            onClick={() => navigate(`/doctors/${item.value}`)}
                                            className={`flex items-center gap-3 p-3 rounded-xl cursor-pointer transition-all duration-200 ${speciality === item.value ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-md' : 'hover:bg-indigo-50'}`}
                                        >
                                            <svg className={`w-5 h-5 ${speciality === item.value ? 'text-white' : 'text-indigo-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                {filterDoc.map((doctor, index) => (
                                    ...
                                    >
                                        <div
                                            ...
                                            className={`bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform ${hoveredCard === doctor.id ? 'scale-105 rotate-x-2 rotate-y-2' : 'scale-100 rotate-0'} perspective-1000 animate-fade-in delay-300 border border-gray-100 group relative z-10`}
                                        >
            ...
            <style jsx>{`
                ...
                /* Add custom scrollbar for the specialty menu */

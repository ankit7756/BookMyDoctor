...
const paymentEsewa = async (req, res) => {
    try {
        ...
        // Since this is a mock payment, we just return success
        res.json({
            success: true,
...
const verifyEsewa = async (req, res) => {
    try {
        ...
        // Update both payment and completion status
        await Appointment.update(
            {
                payment: true,
                isCompleted: false  // Keep isCompleted false until the appointment actually happens
            },
            { where: { id: appointmentId } }
        );
...
export { registerUser, loginUser, getProfile, updateProfile, bookAppointment, listAppointment, cancelAppointment, paymentEsewa, verifyEsewa }
